...
(function () {
  ...
  const tokenReplacements = {
    ...
    /* Yellow */
    fede5d:
      'color: #f4ee14; ;text-shadow: 0 0 2px #001716, 0 0 3px #f39f05[NEON_BRIGHTNESS], 0 0 5px #f39f05[NEON_BRIGHTNESS], 0 0 8px #f39f05[NEON_BRIGHTNESS]; backface-visibility: hidden;',
  };
  ...
  const initNeonDreams = (disableGlow, obs) => {
    ...
    let updatedThemeStyles = !disableGlow ? replaceTokens(initialThemeStyles, tokenReplacements) : initialThemeStyles;
