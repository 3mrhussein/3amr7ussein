//path :   C:\Users\Amr\.vscode\extensions\robbowen.synthwave-vscode-0.1.15\src\js\theme_template
...
(function () {
  ...
  const tokenReplacements = {
    ...
    "72f1b8":
      "color: #399949; text-shadow: 0 0 2px #100c0f, 0 0 10px #257c5572, 0 0 15px #21272472; backface-visibility: hidden;",
    /* Blue */
    "36f9f6":
      "color: #fff; text-shadow: 0 0 2px #001716, 0 0 3px #03edf972, 0 0 4px #22a1ff, 0 0 6px #03adf2; backface-visibility: hidden;",
    /* Red */
    fe4450:
      "color: #578dff; text-shadow: 0 0 2px #000, 0 0 2px #fa4b6a[NEON_BRIGHTNESS], 0 0 3px #fa4b6a[NEON_BRIGHTNESS], 0 0 1px #f76d85[NEON_BRIGHTNESS]; backface-visibility: hidden;",
    /* Neon pink */
    ff7edb: "color: #f77dc5;",

    /* Yellow */
    fede5d:
      "color: #f4ee14; ;text-shadow: 0 0 2px #001716, 0 0 3px #f39f0572, 0 0 4px #f39f0572, 0 0 6px #f39f0572; backface-visibility: hidden;",
  };
  //=============================
  // Helper functions
  //=============================
...
/* Add the subtle gradient to the editor background */
 .monaco-editor { 
  ...
  background-image: linear-gradient(to bottom, #111 50%, #222);
